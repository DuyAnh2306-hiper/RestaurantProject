...
public class ThongKe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnXemFile = new javax.swing.JButton();
        ...
        mnExit1 = new javax.swing.JMenuItem();
        ...
        btnXemFile.setBackground(new java.awt.Color(255, 255, 255));
        btnXemFile.setFont(new java.awt.Font("Lucida Grande", 1, 13)); // NOI18N
        btnXemFile.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/eye-2-32.png"))); // NOI18N
        btnXemFile.setText("Xem File");
        btnXemFile.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btnXemFile.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        btnXemFile.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnXemFileActionPerformed(evt);
            }
        });
                ...
                .addGroup(pnlToolLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlToolLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlToolLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnXemFile, javax.swing.GroupLayout.DEFAULT_SIZE, 80, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(pnlToolLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        pnlToolLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btnChiTiet, btnThem, btnXemFile, btnXuatFile});
        ...
        pnlToolLayout.setVerticalGroup(
            ...
            .addGroup(pnlToolLayout.createSequentialGroup()
                ...
                .addGroup(pnlToolLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnXemFile, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(18, 18, 18)
                .addComponent(jPanel8, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        pnlToolLayout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {btnChiTiet, btnThem, btnXemFile, btnXuatFile});
        ...
        pnlTimkiem1Layout.setHorizontalGroup(
            ...
            .addGroup(pnlTimkiem1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(spnLuongDen, javax.swing.GroupLayout.DEFAULT_SIZE, 156, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cboHinhThucTT, 0, 102, Short.MAX_VALUE)
                    .addComponent(cboNguoiLapHoaDon, 0, 102, Short.MAX_VALUE)
                    .addComponent(cboNguoiThanhToanHD, 0, 102, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel9Layout.createSequentialGroup()
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addComponent(cboLoaiNguyenLieu, 0, 242, Short.MAX_VALUE))
                .addGap(18, 18, 18)
        ...
        mnExit1.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_E, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        mnExit1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/cancel-24.png"))); // NOI18N
        mnExit1.setText("Thoát");
        jMenu2.add(mnExit1);
    ...
    private void btnXemFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXemFileActionPerformed
        // TODO add your handling code here:
        this.btnXemFileActionPerformed();
    }//GEN-LAST:event_btnXemFileActionPerformed
    ...
    private javax.swing.JButton btnXemFile;
    ...
    private javax.swing.JMenuItem mnExit1;
...
//            QLPhieuNhapCT.fillTable(tblPhieuNhapCT);
    ...
    private void thongKe(JTable tbl, int col) {
        ...
        if (pnlNhanVien.equals(component)) {
            ...
            updateStatus(txtTong, true, Color.white);
            updateStatus(txtMax, true, Color.white);
            updateStatus(txtMin, true, Color.white);
...
//    public static CaTruc caTruc = new CaTruc();

    private void btnChiTietActionPerformed() {
        if (pnlNhanVien.isShowing()) {
            int index = Integer.parseInt(String.valueOf(tblNhanVien.getSelectedRow()));
            if (index < 0) {
                MsgBox.alert(this, "Vui lòng chọn hàng!");
                return;
            }
            String maNV = String.valueOf(tblNhanVien.getValueAt(index, 0));
            Entity.nhanVien = QLNhanVien.dao.selectById(maNV);
            new ThemMoi().setVisible(true);
            this.dispose();

        } else if (pnlCaTruc.isShowing()) {
            int index = Integer.parseInt(String.valueOf(tblCaTruc.getSelectedRow()));
            if (index < 0) {
                MsgBox.alert(this, "Vui lòng chọn hàng!");
                return;
            }
            String tenNhanVien = String.valueOf(tblCaTruc.getValueAt(index, 1));
            String maNV = QLNhanVien.dao.selectByName(tenNhanVien).getMaNV();
            String ngayTruc = String.valueOf(tblCaTruc.getValueAt(index, 0));
    ...
    private void btnXemFileActionPerformed() {
        if (pnlNhanVien.isShowing()) {
