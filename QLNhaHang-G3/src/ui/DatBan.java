...
public class DatBan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnDoiBan.setBackground(new java.awt.Color(255, 255, 255));
        btnDoiBan.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btnDoiBan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/plus-32.png"))); // NOI18N
        btnDoiBan.setText("Đổi Bàn");
        btnDoiBan.setToolTipText("Thêm bàn mới");
        btnDoiBan.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 0, 2, new java.awt.Color(255, 204, 102)));
        btnDoiBan.setFocusable(false);
        btnDoiBan.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btnDoiBan.setMaximumSize(new java.awt.Dimension(90, 60));
        btnDoiBan.setMinimumSize(new java.awt.Dimension(90, 60));
        btnDoiBan.setPreferredSize(new java.awt.Dimension(90, 60));
        btnDoiBan.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        btnDoiBan.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnDoiBanMouseClicked(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                btnDoiBanMouseReleased(evt);
            }
        });
    ...
    private void btnDoiBanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDoiBanMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_btnDoiBanMouseClicked

    private void btnDoiBanMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDoiBanMouseReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_btnDoiBanMouseReleased
