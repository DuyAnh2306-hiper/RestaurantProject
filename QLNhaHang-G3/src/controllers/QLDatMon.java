...
//            }
    ...
    public static float capNhatGiamGia(JTable tblHoaDon, int row, float giamGia) {
        ...
        String thanhTien = String.valueOf(Math.round((donGia * soLuong) - giamGia));
...
//            capNhatGiamGia(tblHoaDon, i, giamGia);
        }
//        System.out.println("Tong giam gia:" + sum);
        return sum;
    }
...
//            System.out.println("Thanh Tien trong tongHoaDon()" + thanhTien);
        }
//        System.out.println("Tong hoa don:" + sum);
